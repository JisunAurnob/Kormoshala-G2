...
<?php 
	...
	//$_GET['username'];
 ?>
<form method="post" action="<?php echo htmlspecialchars('Controler/editCorporateEmployerControler.php');?>">
  <fieldset>
...
<label for="name" style="font-family: Raleway; font-size: 20px; color: #4d0000;"> Company Name </label>
    <input type="text" id="name" name="name" value="<?php echo $compName; ?>" style="width: 100%;">
  ...
  <label for="tradelicense" style="font-family: Raleway; font-size: 20px; color: #4d0000;"> Trade License No: </label>
    <input type="text" id="tradelicense" name="tradelicense" value="<?php echo $tradelicense; ?>"  style="width: 100%;">
